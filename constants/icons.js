...
export const youtube_icon = require("../assets/icons/youtube-logo.png");
export const discord_icon = require("../assets/icons/discord-icon.png");
export const check_icon = require("../assets/icons/check-icon.png");
