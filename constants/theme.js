...
export const FONTS = {
    ...
    p: { fontFamily: "Montserrat-Regular", fontSize: SIZES.p, lineHeight: 36 },
    h2: { fontFamily: "Montserrat-Bold", fontSize: SIZES.h2, lineHeight: 30 },
    h3: { fontFamily: "Montserrat-Black", fontSize: SIZES.h3, lineHeight: 22 },
    h4: { fontFamily: "Montserrat-Black", fontSize: SIZES.h4, lineHeight: 22 },
